...
- Create a copy of ``VinTwitta/settings/local.py.example`` in ``VinTwitta/settings/local.py``
- Create a ``.env`` file in the root of the project and add ``DJANGO_SETTINGS_MODULE="VinTwitta.settings.local"`` to it
